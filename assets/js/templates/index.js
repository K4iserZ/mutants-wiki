window.MGG_TEMPLATES = {
  renderShell() {
    ...
    app.innerHTML = `<div class="ticker"><div class="ticker__label">New entries</div><div class="ticker__track"><div class="ticker__content" id="tickerContent"></div></div></div><header class="topbar"><a href="${url('/')}" class="brand"><span class="brand__helix" aria-hidden="true"><svg viewBox="0 0 40 40"><path class="helix-a" d="M4 4c10 8 22 8 32 0M4 20c10 8 22 8 32 0M4 36c10 8 22 8 32 0"/><path class="helix-b" d="M4 4c10-8 22-8 32 0M4 20c10-8 22-8 32 0M4 36c10-8 22-8 32 0"/></svg></span><span class="brand__text">MGG <em>WIKI</em></span></a><nav class="mainnav"><a href="${url('/mutants')}">Mutants</a><a href="#" class="is-disabled">Genes</a><a href="#" class="is-disabled">Events</a><a href="#" class="is-disabled">Guides</a></nav><div class="topbar__search"><input type="search" id="quickSearch" placeholder="Search specimen..." autocomplete="off"></div></header><main class="page" id="pageContent"><p class="loading">Loading...</p></main><footer class="sitefooter"><div class="sitefooter__helix" aria-hidden="true"></div><p class="sitefooter__note">Current data: local JSON. The source can be replaced with an API through DATA_BASE.</p></footer>`;
